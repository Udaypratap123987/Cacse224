    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cb_playing.setOnClickListener{
            if(cb_playing.isChecked)
                Toast.makeText(this@MainActivity,"You checked Playing Cricket",Toast.LENGTH_SHORT).show()
            if(!cb_playing.isChecked)
                Toast.makeText(this@MainActivity,"You Unchecked Playing Cricket",Toast.LENGTH_SHORT).show()
        }
        cb_coding.setOnClickListener{
            if(cb_coding.isChecked)
                Toast.makeText(this@MainActivity,"You checked coding",Toast.LENGTH_SHORT).show()
            if(!cb_coding.isChecked)
                Toast.makeText(this@MainActivity,"You Unchecked coding",Toast.LENGTH_SHORT).show()
        }
        cb_watching.setOnClickListener{
            if(cb_watching.isChecked)
                Toast.makeText(this@MainActivity,"You checked Watching Movie",Toast.LENGTH_SHORT).show()
            if(!cb_watching.isChecked)
                Toast.makeText(this@MainActivity,"You Unchecked Watching Movie",Toast.LENGTH_SHORT).show()
        }
        cb_singing.setOnClickListener{
            if(cb_singing.isChecked)
                Toast.makeText(this@MainActivity,"You checked Singing",Toast.LENGTH_SHORT).show()
            if(!cb_singing.isChecked)
                Toast.makeText(this@MainActivity,"You Unchecked Singing",Toast.LENGTH_SHORT).show()
        }
        rb_male.setOnClickListener{
            Toast.makeText(this@MainActivity,"You selected Male",Toast.LENGTH_SHORT).show()
        }
        rb_female.setOnClickListener{
            Toast.makeText(this@MainActivity,"You selected Female",Toast.LENGTH_SHORT).show()
        }
        rb_other.setOnClickListener{
            Toast.makeText(this@MainActivity,"You selected Other",Toast.LENGTH_SHORT).show()
        }
